...
### AI Models
> **Note:** Training notebooks for each detection method live in [`training_notebooks/`](training_notebooks). Upload the relevant `.ipynb` to Google Colab and follow the in-notebook instructions.
