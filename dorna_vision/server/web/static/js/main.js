...
import { VisionClient, VisionServerError } from "/static/js/api.js?v=64";
import * as Cameras    from "/static/js/cameras.js?v=64";
import * as Playground from "/static/js/playground.js?v=64";
